...
echo existing verified A0 captures -^> D4/D5 -^> quality -^> D6/D9
echo ============================================================
echo.
...
echo [1/4] Rebuild D4-D5 from the four verified official captures...
...
echo.
echo [2/4] Normalize 152-FZ article -^> point hierarchy...
%PYTHON_EXE% scripts\normalize_pdn_d4_d5_article_points.py
if errorlevel 1 goto :fail

echo.
echo [3/4] Enforce fail-closed D4-D5 quality gate...
%PYTHON_EXE% scripts\audit_pdn_d4_d5_structure.py
if errorlevel 1 goto :fail

echo.
echo [4/4] Extract D6-D9 review candidates with exact lineage...
%PYTHON_EXE% scripts\run_pdn_d6_d9.py
if errorlevel 1 goto :fail

echo.
echo ============================================================
echo PASS: PDN conveyor reached D9 review candidates.
